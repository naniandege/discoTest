...
import com.example.liqian.huarong.views.SignatureView;
...
public class ContractActivity extends BaseActivity<TaskDetailView, TaskDetailPresenter> implements TaskDetailView {
    ...
    TextView tvMakeDate;
    @BindView(R.id.oa_nvar100_20)
    TextView oaNvar10020;
    ...
    TextView oaNvar1004;
    @BindView(R.id.oa_deci2_23)
    TextView oaDeci223;
    @BindView(R.id.oa_deci2_3)
    TextView oaDeci23;
    @BindView(R.id.oa_nvar100_5)
    TextView oaNvar1005;
    @BindView(R.id.oa_nvar100_7)
    TextView oaNvar1007;
    @BindView(R.id.oa_deci2_1)
    TextView oaDeci21;
    @BindView(R.id.oa_check_1)
    TextView oaCheck1;
...
//                temp = s;
    ...
    public void setData(String data) {
        ...
        if (pubReturn.getState()) {
            ...
            oaNvar10020.setText(_entOa.getoa_nvar100_20());
            ...
            oaNvar1007.setText(_entOa.getoa_nvar100_7());
            double deci21 = _entOa.getoa_deci2_1();
            //让Double类型完整显示，不用科学计数法显示E
            BigDecimal bigDecimal = new BigDecimal(deci21);
            String amount = bigDecimal.toString();
            String setAm = Amount.setAm(amount);
            oaDeci21.setText(setAm);
            oaDeci23.setText(_entOa.getoa_deci2_3() + "");
            oaDeci223.setText(_entOa.getoa_deci2_2() + "");
            if (_entOa.getoa_check_1() == 0) {
                oaCheck1.setText("否");
            } else {
                oaCheck1.setText("是");
            }
        ...
        if (state == true) {
            if (handWriteView.isSign()) {
                if (wfEnt != null) {
                    ...
                    Common.httpPost(BLL.TaskDispose(wfEnt), 3, ContractActivity.this, new DealWithListener() {
                        @Override
                        public void ServerDataDealWith(PubReturn pubReturn) {
                            ...
                            Common.httpPost(BLL.UploadFile(ent_upfile), 5, ContractActivity.this,
