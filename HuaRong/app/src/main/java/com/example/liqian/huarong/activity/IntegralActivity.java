...
import com.example.liqian.huarong.adapter.AttDetailAdapter;
...
public class IntegralActivity extends BaseActivity<TaskDetailView, TaskDetailPresenter> implements TaskDetailView {
    ...
    private ArrayList<EntityOA> arrayList;
...
//                temp = s;
        ...
        //适配器绑定
        adapter = new AttDetailAdapter(arrayList, this);
        lv2.setAdapter(adapter);
        //recycleView显示方式:线性
        lv2.setLayoutManager(new LinearLayoutManager(this));
        //分割线
        lv2.addItemDecoration(new DividerItemDecoration(this, linearLayoutManager1.VERTICAL));
    }
    ...
    public void setData(String data) {
        ...
        if (pubReturn.getState()) {
            ...
            oal_nvar100_1.setText(_entOa.getoa_nvar100_1());
        ...
        if (state == true) {
            if (handWriteView.isSign()) {
                if (wfEnt != null) {
                    ...
                    Common.httpPost(BLL.TaskDispose(wfEnt), 3, IntegralActivity.this, new DealWithListener() {
                        @Override
                        public void ServerDataDealWith(PubReturn pubReturn) {
                            ...
                            Common.httpPost(BLL.UploadFile(ent_upfile), 5, IntegralActivity.this,
