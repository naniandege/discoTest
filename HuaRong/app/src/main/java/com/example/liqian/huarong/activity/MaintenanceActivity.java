...
public class MaintenanceActivity extends BaseActivity<TaskDetailView, TaskDetailPresenter> implements TaskDetailView {
...
//                temp = s;
    ...
    public void setData(String data) {
        ...
        if (pubReturn.getState()) {
            ...
            tvOaNvar1001.setText(_entOa.getoa_date_1());  //维修时间
            oaNvar1001.setText(_entOa.getoa_nvar100_1());       //维修车号
        ...
        if (state == true) {
            if (handWriteView.isSign()) {
                if (wfEnt != null) {
                    ...
                    Common.httpPost(BLL.TaskDispose(wfEnt), 3, MaintenanceActivity.this, new DealWithListener() {
                        @Override
                        public void ServerDataDealWith(PubReturn pubReturn) {
                            ...
                            Common.httpPost(BLL.UploadFile(ent_upfile), 5, MaintenanceActivity.this,
