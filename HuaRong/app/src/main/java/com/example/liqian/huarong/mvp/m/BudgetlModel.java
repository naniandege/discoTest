...
public class BudgetlModel extends BaseMvpModel {
    ...
    public void getStr(String json, final ResultCallback<String> resultCallback) {
        int length = json.length();
        MediaType mediaType = MediaType.parse("text/x-markdown; charset=utf-8");
        RequestBody requestBody = RequestBody.create(mediaType, json);
    ...
    public void upData(String json, final ResultCallback<String> resultCallback) {
        int length = json.length();
        MediaType mediaType = MediaType.parse("text/x-markdown; charset=utf-8");
        RequestBody requestBody = RequestBody.create(mediaType, json);
