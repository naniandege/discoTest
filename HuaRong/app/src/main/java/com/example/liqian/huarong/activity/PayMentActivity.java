...
public class PayMentActivity extends BaseActivity<TaskDetailView, TaskDetailPresenter> implements TaskDetailView {
    ...
    TextView oaDeci23;
    @BindView(R.id.oa_deci2_5)
    TextView oaDeci25;
    @BindView(R.id.oa_deci2_4)
    TextView oaDeci24;
    @BindView(R.id.oa_deci2_6)
    TextView oaDeci26;
...
//                temp = s;
    ...
    public void setData(String data) {
        ...
        if (pubReturn.getState()) {
            ...
            BigDecimal bigDecimal = new BigDecimal(_entOa.getoa_deci2_1());
            String amount = bigDecimal.toString();
            String setAm = Amount.setAm(amount);
            oaDeci21.setText(setAm);

            BigDecimal bigDecima2 = new BigDecimal(_entOa.getoa_deci2_3());
            String amount2 = bigDecima2.toString();
            String setAm2 = Amount.setAm(amount2);
            oaDeci23.setText(setAm2);
            oaDeci24.setText(_entOa.getoa_deci2_4() + "");
            oaDeci25.setText(_entOa.getoa_deci2_5() + "");
            oaDeci26.setText(_entOa.getoa_deci2_6() + "");
        ...
        if (state == true) {
            if (handWriteView.isSign()) {
                if (wfEnt != null) {
                    ...
                    Common.httpPost(BLL.TaskDispose(wfEnt), 3, PayMentActivity.this, new DealWithListener() {
                        @Override
                        public void ServerDataDealWith(PubReturn pubReturn) {
                            ...
                            Common.httpPost(BLL.UploadFile(ent_upfile), 5, PayMentActivity.this,
