...
public class TheSealActivity extends BaseActivity<TaskDetailView, TaskDetailPresenter> implements TaskDetailView {
    ...
    protected int getLayoutId() {
        return R.layout.activity_the_seal;
    }
...
//                temp = s;
    ...
    public void setData(String data) {
        ...
        if (pubReturn.getState()) {
            ...
            oaNvar1001.setText(_entOa.getoa_nvarmax_1());
            oaNvarmax1.setText(_entOa.getoa_nvar100_1());
        ...
        if (state == true) {
            if (handWriteView.isSign()) {
                if (wfEnt != null) {
                    ...
                    Common.httpPost(BLL.TaskDispose(wfEnt), 3, TheSealActivity.this, new DealWithListener() {
                        @Override
                        public void ServerDataDealWith(PubReturn pubReturn) {
                            ...
                            Common.httpPost(BLL.UploadFile(ent_upfile), 5, TheSealActivity.this,
