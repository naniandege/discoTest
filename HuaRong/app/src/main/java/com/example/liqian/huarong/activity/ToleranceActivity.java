...
public class ToleranceActivity extends BaseActivity<TaskDetailView, TaskDetailPresenter> implements TaskDetailView {
...
//                temp = s;
    ...
    public void setData(String data) {
        ...
        if (pubReturn.getState()) {
            ...
            personnel.setText(_entOa.getoa_nvar100_1());
            Address.setText(_entOa.getoa_nvar100_2());
        ...
        if (state == true) {
            if (handWriteView.isSign()) {
                if (wfEnt != null) {
                    ...
                    Common.httpPost(BLL.TaskDispose(wfEnt), 3, ToleranceActivity.this, new DealWithListener() {
                        @Override
                        public void ServerDataDealWith(PubReturn pubReturn) {
                            ...
                            Common.httpPost(BLL.UploadFile(ent_upfile), 5, ToleranceActivity.this,
                ...
                Common.httpPost(BLL.TaskDispose(wfEnt), 3, ToleranceActivity.this, new DealWithListener() {
                    ...
                    public void ServerDataDealWith(PubReturn pubReturn) {
                        if (pubReturn.getState()) {
                            ...
                            Intent intent = new Intent(ToleranceActivity.this, SetParticipantsActivity.class);
