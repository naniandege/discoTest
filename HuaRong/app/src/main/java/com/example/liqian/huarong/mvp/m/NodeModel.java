...
public class NodeModel extends BaseMvpModel {
    ...
    public void addData(String string, final ResultCallback<String> resultCallback) {
        int length = string.length();
        MediaType mediaType = MediaType.parse("text/x-markdown; charset=utf-8");
        RequestBody requestBody = RequestBody.create(mediaType, string);
    ...
    public void audit(String string, final ResultCallback<String> resultCallback) {
        int length = string.length();
        MediaType mediaType = MediaType.parse("text/x-markdown; charset=utf-8");
        RequestBody requestBody = RequestBody.create(mediaType, string);
