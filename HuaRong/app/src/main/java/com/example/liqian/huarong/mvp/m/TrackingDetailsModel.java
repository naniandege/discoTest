...
public class TrackingDetailsModel extends BaseMvpModel {
    public void details(String string, final ResultCallback<String> resultCallback) {
    ...
    public void historylist(String json, final ResultCallback<String> resultCallback) {
