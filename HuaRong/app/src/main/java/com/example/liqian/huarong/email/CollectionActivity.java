...
import com.example.liqian.huarong.adapter.CollectAdapter;
...
public class CollectionActivity extends BaseActivity<DraftView, DraftPresenter> implements DraftView, OutBoxAdapter.onClickLisnner {
    ...
    public void setData(String data) {
        ...
        if (stringPick != null) {
            ...
            if (pubReturn.getState()) {
                ...
                entityBase.sethave_pers_code(Common.LoginUser.getpers_code());
