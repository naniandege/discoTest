...
public class BorrowingActivity extends BaseActivity<TaskDetailView, TaskDetailPresenter> implements TaskDetailView {
...
//                temp = s;
    ...
    public void setData(String data) {
        ...
        if (pubReturn.getState()) {
            ...
            oaNvar1002.setText(_entOa.getoa_nvar100_2() + "（天）");
            oaNvar1003.setText(_entOa.getoa_nvar100_3());
            oaNvarmax1.setText(_entOa.getoa_nvarmax_1());
            oaDeci21.setText(_entOa.getoa_deci2_1() + "（万元）");
            oaDeci22.setText(_entOa.getoa_deci2_2() + "");
        ...
        if (state == true) {
            if (handWriteView.isSign()) {
                if (wfEnt != null) {
                    ...
                    Common.httpPost(BLL.TaskDispose(wfEnt), 3, BorrowingActivity.this, new DealWithListener() {
                        @Override
                        public void ServerDataDealWith(PubReturn pubReturn) {
                            ...
                            Common.httpPost(BLL.UploadFile(ent_upfile), 5, BorrowingActivity.this,
