...
public class FieldActivity extends BaseActivity<TaskDetailView, TaskDetailPresenter> implements TaskDetailView {
        ...
        if (state == true) {
            if (handWriteView.isSign()) {
                if (wfEnt != null) {
                    ...
                    Common.httpPost(BLL.TaskDispose(wfEnt), 3, FieldActivity.this, new DealWithListener() {
                        @Override
                        public void ServerDataDealWith(PubReturn pubReturn) {
                            ...
                            Common.httpPost(BLL.UploadFile(ent_upfile), 5, FieldActivity.this,
