...
import com.example.library.glide.SignStreamLocalUriFetcher;
...
public class SignModelLoader  extends StreamUriLoader{
    ...
    public static class Factory implements ModelLoaderFactory<Uri, InputStream> {
        ...
        public ModelLoader<Uri, InputStream> build(Context context, GenericLoaderFactory factories) {
            return new com.example.library.glide.SignModelLoader(context, factories.buildModelLoader(GlideUrl.class, InputStream.class));
        }
